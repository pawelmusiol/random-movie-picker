...
const LoginDialog = () => {
    ...
    const [Open, setOpen] = useState(context.loginOpen)
    ...
    return (
        <>
            ...
            <Dialog maxWidth='md' open={Open} onClose={handleClose}>
                ...
                <CustomSnackbar key="loginMessage" snackbarState={SnackbarState} onClose={() => setSnackbarState({...SnackbarState, open: false})} />
            </Dialog>
